    ...
    <div className="min-h-screen bg-gradient-to-br from-[#98f0b7] via-[#2ec362] to-accent flex flex-col items-center justify-between relative overflow-x-hidden">
      ...
      <header className="w-full bg-white/30 backdrop-blur-md shadow-lg px-4 md:px-8 py-4 flex flex-col md:flex-row items-center md:justify-around justify-center sticky top-0 z-50 border-b border-white/40 gap-2 md:gap-0 mt-5 md:mt-0">
        ...
        <nav className="flex flex-col md:flex-row gap-2 md:gap-4 lg:gap-8 items-center w-full md:w-auto justify-center">
          <a href="#explore" className="w-full md:w-auto text-center px-4 py-2 rounded-full bg-darkblue text-white font-semibold shadow hover:bg-accent hover:text-white transition-all duration-200">Explore</a>
          <a href="#about" className="w-full md:w-auto text-center px-4 py-2 rounded-full bg-darkblue text-white font-semibold shadow hover:bg-accent hover:text-white transition-all duration-200">About</a>
          <button className="w-full md:w-auto text-center px-5 py-2 rounded-full bg-gradient-to-r from-accent to-[#5fc35d] text-white font-bold shadow-lg hover:scale-105 hover:from-[#5fc35d] hover:to-accent transition-all duration-200 border-none">Login / Signup</button>
        </nav>
      </header>
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center py-8 md:py-20 text-center animate-fade-in px-2 sm:px-4 sm:max-w-3xl">
        ...
        <p className="text-base sm:text-lg md:text-2xl text-white max-w-4xl mx-auto mt-4 mb-8 font-bold italic">Discover, review, and share the best outdoor calisthenics and workout locations near you. Join a community passionate about fitness and the outdoors!</p>
      ...
      <main ref={mapSectionRef} className="flex flex-col justify-center items-center flex-1 w-full pb-8 md:pb-12 px-1 sm:px-2">
        <div className="w-full max-w-5xl m-4 md:m-0 bg-white/80 rounded-3xl shadow-2xl p-2 sm:p-4 md:p-10 border border-white/60 backdrop-blur-md animate-fade-in-up">
          <MapExplorerPage />
        </div>
      </main>
      {/* Footer */}
